...
actor {
  ...
  public func get_message_by_hash(message_hash: Blob) : async ?DiodeMessages.Message {
    DiodeMessages.get_message_by_hash(dm, message_hash);
  };

  public func get_message_by_id(message_id: Nat32) : async DiodeMessages.Message {
